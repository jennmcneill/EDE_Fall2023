...
```{r Ozone Distribution Boxplot 2018, echo=FALSE, message=FALSE, warning=FALSE, fig.align='left', fig.cap="Ozone Distribution Boxplot 2018", fig.height=4, fig.width=6}
...
Ozone_2018_Plot <-
  ...
  ggtitle("Ozone Levels by Month in 2018")
print(Ozone_2018_Plot)

```

```{r Ozone Distribution Boxplot 2019, echo=FALSE, message=FALSE, warning=FALSE, fig.align='left', fig.cap="Ozone Distribution Boxplot 2019", fig.height=4, fig.width=6}
...
Ozone_2019_Plot <-
  ...
  scale_x_discrete(drop = FALSE)+
  ylab(expression(paste("Ozone (", mu, "g/m"^"3", ")")))+
  ggtitle("Ozone Levels by Month in 2019")
...
[My Github Repository](https://github.com/jennmcneill/EDE_Fall2023/tree/main)
