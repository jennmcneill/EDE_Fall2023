...
#trying to explain irradiance based on depth
#you don't need to use the $ here because we defined our data
#this is the preferred way of calling the lm() function
...
#there is a significant negative correlation between irradiance and depth: lower irradiance levels at lower depth
#the model explains about 31% of the total variance in irradiance (we know this because the R^2 value is 0.3091)
```
...
#divide plot screen into a grid of four cells
...
#this plot clearly shows us that we don't have a linear relationship between x and y
#we can try to log transform the values
```
...
irradiancebydepth2 <- 
  ...
  #remove the gray "confidence interval" with se = FALSE
