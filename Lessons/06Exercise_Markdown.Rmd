...
#this command does the same thing as adding the same thing in the curly brackets with the code chunk title
...
#you can use a command from a library without importing the whole library with the :: afterwards
#colons on the right and the left in the output have to do with the alignment (left or right) of the text
