...
# Scatterplot #this shows two different ways to do the same thing
...
O3plot2 <- ggplot(EPAair) +
  #geom_point(aes(x = Date, y = Ozone, color = "blue")) #this is the wrong way
  geom_point(aes(x = Date, y = Ozone), color = "blue") #put color outside parentheses
print(O3plot2)

# Add additional variables
# How could you automatically assign a marker color to a variable? ggplot does this automatically
# this is asking R to assign a different shape to each dot based on the year
PMplot <- 
...
tempvsdepth <- 
  ...
  geom_point() +
  scale_y_reverse() #change the y axis to have 0 on top and 20 on bottom
print(tempvsdepth)
...
Nutrientplot3 <-
  ...
  geom_boxplot(aes(color = nutrient)) # Why didn't we use "fill"? fill only fills the box and keeps everything else black. ugly!
print(Nutrientplot3)
